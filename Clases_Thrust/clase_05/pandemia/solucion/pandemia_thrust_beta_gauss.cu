...
int main(void)
{
   ...
   auto input_begin=thrust::make_zip_iterator( thrust::make_tuple(S.begin(), I.begin(), R.begin(),beta.begin()) );
   auto input_end=thrust::make_zip_iterator( thrust::make_tuple(S.end(), I.end(), R.end(),beta.end()) );		
   auto output=thrust::make_zip_iterator( thrust::make_tuple(S.begin(), I.begin(), R.begin()) );
	...
	std::cout << "\n";
    	...
    	thrust::transform(input_begin, input_end, output,arbitrary_functor1());
    }	
}
