// nvcc -arch=sm_35 -rdc=true async_reduce_thrust.cu -lcudadevrt -lnvToolsExt -o a.out
/*
 * Este ejemplo, adaptado de un ejemplo de la libreria thrust, muestra
 * 1) el uso de algoritmos de thrust desde device code
 * 2) el uso de paralelismo dinamico
 * 3) como hacer una reduccion asincronica con thrust
 * 4) el uso de nvtx
 * 5) uso de c++11 ...
 */
