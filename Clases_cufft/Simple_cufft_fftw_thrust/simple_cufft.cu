...
// TODO: 
// Declare/aloque un container "D_anti" de Thrust para guardar la antitransformada 
// y el raw_pointer "d_anti" para pasar a CUFFT
...
#ifdef IMPRIMIR
// TODO:
// Declare/aloque dos host containers de Thrust para que la impresion de abajo funcione: 
// "H_anti" para guardar la antitransformada, 
// "H_input" para copiar el input original generado en el device
// Copie los respectivos contenidos del device al host
// Con ellos, imprima en un file el input original y la antitransformada de la transformada, para comparar
	ofstream senial_out("senial_vs_antitransformada.dat");
	for(int j = 0 ; j < N ; j++){
		//senial_out << H_input[j] << " " << H_anti[j]/N << endl; // descomentar cuando H_input y H_anti existan
	}
	//se puede graficar asi en gnuplot > plot 'senial_vs_antitransformada.dat' u 0:1, '' u 0:2 w l
#endif
	return 0;
}
